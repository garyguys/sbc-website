...
export default function ThankYou() {
    ...
    const isEvent = params.get('sent') === 'event';
                ...
                <section className="band">
                    <div className="shell">
                        <div className="card mx-auto max-w-2xl p-8 text-center sm:p-12">
                            ...
                            <p className="eyebrow mt-8">{isEvent ? 'Event received' : 'Message sent'}</p>
                            ...
                            {isEvent ? (
                                <p className="mx-auto mt-6 max-w-lg text-xl leading-relaxed text-ink-700">
                                    Your event is in. Garrett reviews each submission and adds it to the calendar, usually
                                    within a few days. You will get an email if anything needs clarifying.
                                </p>
                            ) : (
                                <>
                                    <p className="mx-auto mt-6 max-w-lg text-xl leading-relaxed text-ink-700">
                                        Your message is on its way to us. A real person will read it and reply within a
                                        couple of business days, by email or by phone if you asked for a call.
                                    </p>
                            ...
                            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                                <Link to={isEvent ? '/#events' : '/directory'} className="btn-accent w-full sm:w-auto">
                                    {isEvent ? 'See the calendar' : 'Browse the directory'}
